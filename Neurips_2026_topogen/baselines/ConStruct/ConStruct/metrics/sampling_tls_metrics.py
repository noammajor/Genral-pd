...
class TLSSamplingMetrics(SpectreSamplingMetrics):
    ...
    def forward(self, generated_graphs: list, current_epoch, local_rank, save_dir: str = "."):
        to_log = super().forward(generated_graphs, current_epoch, local_rank, save_dir=save_dir)
        if local_rank == 0:
            print(
